...
# --- CONFIGURATION ---
onnx_model_path = "/disk/diamond-scratch/cvaro009/data/onnx_models/mobilebert_onnx/model.onnx"
tokenizer_dir = "/disk/diamond-scratch/cvaro009/data/mobilebert"  # or your original MobileBERT model folder
test_csv_path = "/aul/homes/cvaro009/Desktop/LLMComp2025/data/processed/unified/unified_test.csv"
results_dir = "/aul/homes/cvaro009/Desktop/LLMComp2025/onnx_results/mobilebert_onnx"
...
plt.title("Confusion Matrix: MobileBERT ONNX")
plt.savefig(os.path.join(results_dir, "confusion_matrix_mobilebert_onnx.png"))
plt.close()
...
print(f"MobileBERT ONNX Accuracy: {acc:.4f}")
