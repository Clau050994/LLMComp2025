...
# --- CONFIGURATION ---
onnx_model_path = "/disk/diamond-scratch/cvaro009/data/onnx_models/distilbert_onnx/model.onnx"
tokenizer_dir = "/disk/diamond-scratch/cvaro009/data/distilbert" 
test_csv_path = "/aul/homes/cvaro009/Desktop/LLMComp2025/data/processed/unified/unified_test.csv"
results_dir = "/aul/homes/cvaro009/Desktop/LLMComp2025/onnx_results/distilbert_onnx"
...
plt.title("Confusion Matrix: DistilBERT ONNX")
plt.savefig(os.path.join(results_dir, "confusion_matrix_distilbert_onnx.png"))
plt.close()
...
print(f"DistilBERT ONNX Accuracy: {acc:.4f}")
