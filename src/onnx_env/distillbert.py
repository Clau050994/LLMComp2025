...
if __name__ == "__main__":
    # Paths
    model_dir = "/disk/diamond-scratch/cvaro009/data/distilbert"
    onnx_dir = "/disk/diamond-scratch/cvaro009/data/onnx_models/distilbert_onnx"

    # Export the model
    success = export_model_to_onnx(model_dir, onnx_dir, "distilbert")
