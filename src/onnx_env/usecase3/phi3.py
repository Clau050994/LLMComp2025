...
if __name__ == "__main__":
    model_dir = "/disk/diamond-scratch/cvaro009/data/usecase3/phi3_risk_classification_qlora"
    onnx_dir = "/disk/diamond-scratch/cvaro009/data/usecase3/onnx_models/phi3_onnx"
