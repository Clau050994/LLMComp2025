#!/usr/bin/env python3
"""
Export an ALBERT model to ONNX and quantize it to INT8.
"""
...
def export_and_quantize(model_dir, export_dir, opset=14):
    ...
    onnx_fp32_path = os.path.join(export_dir, "albert_fp32.onnx")
    onnx_quant_path = os.path.join(export_dir, "albert_int8.onnx")
...
if __name__ == "__main__":
    MODEL_DIR = "/a/buffalo.cs.fiu.edu./disk/jccl-002/homes/melsh008/Generate/albert_verification_finetuned"
    EXPORT_DIR = "/disk/diamond-scratch/melsh008/albert_export_onnx"
