#!/usr/bin/env python3
"""
Train DistilBERT (distilbert-base-multilingual-cased) on a CSV dataset to predict language.
"""
...
training_args = TrainingArguments(
    ...
    save_strategy="steps",         # Save every N steps instead of per epoch
    save_steps=500,                # Save checkpoint every 500 steps (customize)
...
resume_checkpoint = "./distilbert_output/checkpoint-122000"
 # change to your desired checkpoint
