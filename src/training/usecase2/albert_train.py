...
# === Tokenize ===
def tokenize(batch):
    texts = [str(t) if t is not None else "" for t in batch["english"]]
    return tokenizer(
        texts,
        padding="max_length",
        truncation=True,
        max_length=512   # ALBERT max recommended is 512
    )
...
def compute_metrics(pred):
    ...
    plt.title("Confusion Matrix - ALBERT Language Classification")
    plt.tight_layout()
...
print("✅ Starting ALBERT training...")
trainer.train()
...
print("✅ ALBERT training complete.")
